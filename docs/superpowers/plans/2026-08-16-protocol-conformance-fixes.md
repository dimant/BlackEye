...
**Status:** Tasks 0, 1 and 2 are complete. The solution is on `net10.0` and `BlackEye.Tests` holds 108 passing tests. Tasks 3-11 are not started.
...
- [ ] **Step 3: Fix the length byte and set the last-frame bit**
